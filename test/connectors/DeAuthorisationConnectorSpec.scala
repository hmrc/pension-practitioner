...
class DeAuthorisationConnectorSpec
  ...
  private lazy val connector: DeAuthorisationConnector =
    injector.instanceOf[DeAuthorisationConnector]

  private val pstr: String = "pstr"

  private val pspDeAuthorisationUrl = s"/pension-online/cease-scheme/pods/$pstr"

  "DeAuthorisationConnector" must {
